...
void main() {
  ...
  // ← FIX: setUp sekarang memanggil loadEvents(force: true)
  //   agar _allEvents dan _hasLoaded di controller ikut ter-reset
  setUp(() async {
    await HiveService.events.clear();
    await controller.loadEvents(force: true); // reset cache internal
