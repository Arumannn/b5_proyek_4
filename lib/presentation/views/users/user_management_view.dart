...
import 'package:b5_proyek_4/presentation/widgets/shared/loading_overlay.dart';
import 'package:b5_proyek_4/presentation/widgets/shared/network_status_banner.dart';
...
import 'package:b5_proyek_4/domain/permissions/users/user_permission.dart';
import 'package:b5_proyek_4/presentation/widgets/users/user_form_dialog.dart';
...
Widget _buildTable() {
              ...
              DataCell(
                Row(
                  ...
                  children: [
                    ...
                    if (_canManage) const SizedBox(width: 8),
                    if (_canDelete)
                      IconButton(
                        tooltip: 'Hapus',
                        icon: const Icon(
  ...
  Widget _buildRoleFilterChips() {
    return ListenableBuilder(
      ...
      builder: (context, _) {
        final rolesConfig = ConfigController.instance.activeConfig.rolesConfig;
        final roles = <String>['Semua'];
        roles.addAll(rolesConfig.map((e) => e.roleName));
        return SizedBox(
          height: 42,
